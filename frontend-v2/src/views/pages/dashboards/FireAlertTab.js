...
import FireAlertLogs from "components/FireAlert/FireAlertLogs";
...
class FireAlertTab extends React.Component {
  constructor(props) {
    super(props);
...
export default connect(mapStateToProps)(FireAlertTab);
