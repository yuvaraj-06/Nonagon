  ...
  fetchData = (nextProps) => {
    this._ismounted &&
      axios
        .get(
          nodeBaseURL +
          `customers/delivery_agent/aggregate/${nextProps.outlet}/${nextProps.time}?fromdate=${nextProps.startDate}&tilldate=${nextProps.endDate}`,
          {
            headers: {
        ...
        .then((res) => {
          this._ismounted &&
            this.setState({
              delivery_agent_count: res.data.delivery_agent_count,
                ...
                <Row>
                  <Col md="12">
                    <span className="h2 font-weight-bold mb-0pl-3">
                      ...
                      {this.state.delivery_agent_count}
                    </span>
                  </Col>
                </Row>
              </div>
