  ...
  fetchData = (nextProps) => {
    this._ismounted &&
      axios
        .get(
          nodeBaseURL +
          `billing_manned/list/${nextProps.outlet}/${nextProps.time}?fromdate=${nextProps.startDate}&tilldate=${nextProps.endDate}`,
          {
            headers: {
        ...
        <CardBody className='mp-0'>
          ...
          <div className="mt-2 mb-0 text-sm">
            ...
            <Col>
              ...
              >
                At every 4 minutes interval, the AI checks if the billing counter is manned or unmmaned.
              </Tooltip>
            </Col>
            <Modal
...
export default connect(mapStateToProps)(EntryUnmanned);
