...
class PackagingPrintIndexCard extends Component {
    constructor(props) {
        super(props);
        this.state = {
            exampleModal: false,
    ...
    fetchData = (nextProps) => {
        this._ismounted && axios.get(
            ...
            .then((res) => {
                this._ismounted && this.setState({ bagCount: getPrintIndex(res.data) });
            })
            .catch(console.log);
    };
                                ...
                                <Row className='mt-3'>
                                    <Col md="5">
                                        <span className="h3 font-weight-bold mb-0 text-nowrap">
                                            <center>
                                                {this.state.bagCount.toFixed(2)} /5
                                            </center>
                                        </span>
                                    </Col>
                                </Row>
                                <Row>
                                    <span className='h5 text-muted mt-1'>
                                        <center>
                                            NOTE: Calculated based on the no of bags printed and not printed.
                                        </center>
                                    </span>
                                </Row>
                                <div className="pt-1">
