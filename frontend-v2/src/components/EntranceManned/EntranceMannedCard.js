...
class EntranceManned extends Component {
    constructor(props) {
        super(props);
        this.state = {
            exampleModal: false,
    ...
    fetchData = (nextProps) => {
        this._ismounted && axios.get(
            nodeBaseURL +
            `enterance_manned/aggregate/${nextProps.outlet}/${nextProps.time}?fromdate=${nextProps.startDate}&tilldate=${nextProps.endDate}`,
            {
                headers: {
                ...
                <CardBody>
                    ...
                    <div className="mt-2 mb-0 text-sm">
                        <div className="mt-1">
                            ...
                            <Link to='/admin/enterance-manned'>
                                <Button
                                    color="secondary"
                                    outline
                                    type="button"
                        ...
                        >
                            ...
                            <div className="modal-body">
                                ...
                                <ComparisonGraph
                                    dataType='Count'
                                    route='entrance_manned/hourwise'
