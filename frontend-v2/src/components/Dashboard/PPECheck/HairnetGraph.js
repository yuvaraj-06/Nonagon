  ...
  fetchData = (nextProps) => {
    this._ismounted && axios.get(
      ...
      .then((result) => {
        ...
        var finalData = getPopulatedGraphData(getGraphTimeFrame(nextProps.time), convertPPEData(result.data, 'hairnet'), this.props.time);
    ...
    return (
      <Card>
        ...
        <CardHeader>
          ...
          <h5 className="h3 mb-0">Hairnet not worn detection</h5>
        </CardHeader>
