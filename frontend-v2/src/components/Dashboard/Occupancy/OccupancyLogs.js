...
class OccupancyLogs extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            logsData: [],
            logsColumnInfo: [
                ...
                {
                    dataField: "occupancyCount",
                    text: "Room Occupancy Count",
                    sort: true,
                },
            ],
            logsName: 'Room Occupancy',
            outlet: props.outlet,
            time: props.time,
            daterange: "Loading...",
            filterParameter: '',
    ...
    fetchData = (nextProps) => {
        this._ismounted && axios.get(
            nodeBaseURL +
            `room_occupancy/list/${nextProps.outlet}/${nextProps.time}`,
            {
                headers: {
            ...
            .then((res) => {
                ...
                var x = logs
                    .map((r) => ({
                        ...
                        occupancyCount: Math.round(r.count),
                    }))
