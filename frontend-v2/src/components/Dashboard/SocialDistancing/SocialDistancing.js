...
class SocialDistancing extends Component {
    ...
    fetchData = (nextProps) => {
        this._ismounted && axios.get(
            nodeBaseURL +
            `social_distancing/aggregate/${nextProps.outlet}/${nextProps.time}?fromdate=${nextProps.startDate}&tilldate=${nextProps.endDate}`,
            {
                headers: {
                ...
                <CardBody>
                                ...
                                <Row>
                                    <Col md="12">
                                        <span className="h2 font-weight-bold mb-0pl-3">
                                            ...
                                            {/* {
                                                this.state.noofpeople !== 0 ?
                                                    this.state.noofpeople
                                                    :
                                                    "-"
                                            } */}
                                            {this.state.data.no_social_distancing}
                                        </span>
                                    </Col>
                                </Row>
                            </div>
                    ...
                    <div className="mt-2 mb-0 text-sm">
                        <div className="mt-1">
                            ...
                            <Link to='/admin/social-distancing'>
                                <Button
                                    color="secondary"
                                    outline
                                    type="button"
                        ...
                        <Col>
                            <div className="explr-i" id="explr-tooltip-SD">
                                <i className=" fas fa-info" />
                            </div>
                            <Tooltip
                                placement="top-start"
                                isOpen={this.state.tooltipOpen}
                                target="explr-tooltip-SD"
                                toggle={() => this.toggleTooltip()}
                            >
                                Checks if proper Social Distance is maintained by your customers and employees in your store
                            </Tooltip>
                        </Col>
                        <Modal
                        ...
                        >
                            ...
                            <div className="modal-body">
                                ...
                                <ComparisonGraph
                                    dataType='Count'
                                    route='social_distancing/hourwise'
