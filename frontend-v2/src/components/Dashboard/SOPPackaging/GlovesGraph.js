...
class GlovesGraph extends Component {
  constructor(props) {
    super(props);
    this.state = {
      x: [],
  ...
  render() {
    let chartExample2 = {
          ...
          yAxes: [
            {
              ...
              scaleLabel: {
                display: true,
                labelString: "Glove Deviations Count",
              },
            },
          ],
          xAxes: [
      ...
      data: {
        ...
        datasets: [
          {
            label: "Number of Glove Deviations",
            data: this.state.y,
    ...
    return (
      <Card>
        <CardHeader>
          ...
          <h5 className="h3 mb-0">Glove Deviation Trend</h5>
        </CardHeader>
