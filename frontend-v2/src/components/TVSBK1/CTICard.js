...
class TVSCustomerTimeInsightsCard1 extends Component {
  constructor(props) {
    super(props);
    this.state = {
      exampleModal: false,
      avg_mopeds_timespent: 0,
      avg_scooters_timespent: 0,
      avg_apaches_timespent: 0,
  ...
  fetchData = (nextProps) => {
    this._ismounted &&
      axios
        .get(
          nodeBaseURL +
          `tvs_timespent1/aggregate/${nextProps.outlet}/${nextProps.time}?fromdate=${nextProps.startDate}&tilldate=${nextProps.endDate}`,
          {
            headers: {
        ...
        .then((res) => {
          this._ismounted &&
            this.setState({
              avg_mopeds_timespent: (
                res.data.avg_mopeds_timespent / 60
              ).toFixed(2),
              avg_scooters_timespent: (
                res.data.avg_scooters_timespent / 60
              ).toFixed(2),
              avg_apaches_timespent: (
                res.data.avg_apaches_timespent / 60
              ).toFixed(2),
      ...
      <Card className="card-stats ppe-card">
        <CardBody>
                ...
                <Row>
                  <Col xs="4" sm="4">
                    <span className="h5 font-weight-bold mb-0 text-nowrap">
                      ...
                      <br />
                      {this.state.avg_mopeds_timespent}
                    </span>
                  </Col>
                  ...
                  <Col xs="4" sm="4">
                    <span className="h5 font-weight-bold mb-0 text-nowrap">
                      ...
                      <br />
                      {this.state.avg_scooters_timespent}
                    </span>
                  </Col>
                  ...
                  {Object.keys(this.props.companyServices)[0] !== "GVTPL-KMTTSIN001" ?
                    <Col xs="4" sm="4">
                      <span className="h5 font-weight-bold mb-0 text-nowrap">
                        ...
                        <br />
                        {this.state.avg_apaches_timespent}
                      </span>
                    </Col>
                    : null}
                </Row>
          ...
          <Col>
            ...
            >
              The average time (in mins) spent by the customer at the moped bikes region, at the scooters region and in the apache bikes. For reference image click learn more button.
            </Tooltip>
          </Col>
          <Modal
...
// export default TVSCustomerTimeInsightsCard1;
export default connect(mapStateToProps)(TVSCustomerTimeInsightsCard1);