...
class SecurityPresence extends Component {
    constructor(props) {
        super(props);
        this.state = {
            exampleModal: false,
    ...
    fetchData = (nextProps) => {
        this._ismounted && axios.get(
            nodeBaseURL +
            `security_presence/aggregate/${nextProps.outlet}/${nextProps.time}?fromdate=${nextProps.startDate}&tilldate=${nextProps.endDate}`,
            {
                headers: {
            ...
            .then((res) => {
                this._ismounted && this.setState({
                    unoccupied: res.data.unoccupied,
                ...
                <CardBody>
                    ...
                    <div className="mt-2 mb-0 text-sm">
                        <div className="mt-1">
                            ...
                            <Link to='/admin/security-presence'>
                                <Button
                                    color="secondary"
                                    outline
                                    type="button"
                        ...
                        >
                            ...
                            <div className="modal-body">
                                ...
                                <ComparisonGraph
                                    dataType='Count'
                                    route='security_presence/hourwise'
...
export default SecurityPresence;