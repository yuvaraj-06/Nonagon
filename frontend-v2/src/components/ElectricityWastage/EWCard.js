...
class ElectricityWastage extends Component {
    constructor(props) {
        super(props);
        this.state = {
            exampleModal: false,
            electricity_wastage_count: 0,
    ...
    fetchData = (nextProps) => {
        this._ismounted && axios.get(
            nodeBaseURL +
            `electricity_wastage/aggregate/${nextProps.outlet}/${nextProps.time}?fromdate=${nextProps.startDate}&tilldate=${nextProps.endDate}`,
            {
                headers: {
            ...
            .then((res) => {
                this._ismounted && this.setState({
                    electricity_wastage_count: res.data.electricity_wastage_count,
                ...
                <CardBody>
                                ...
                                <Row>
                                    <Col md="12">
                                        <span className="h2 font-weight-bold mb-0pl-3">
                                            ...
                                            {this.state.electricity_wastage_count > 0 ? "Yes" : "No"}
                                        </span>
                                    </Col>
                                </Row>
                            </div>
                    ...
                    <div className="mt-2 mb-0 text-sm">
                        <div className="mt-1">
                            ...
                            <Link to='/admin/electricity-wastage'>
                                <Button
                                    color="secondary"
                                    outline
                                    type="button"
                        ...
                        <Col>
                            <div className="explr-i" id="explr-tooltip-EW">
                                <i className=" fas fa-info" />
                            </div>
                            <Tooltip
                                placement="top-start"
                                isOpen={this.state.tooltipOpen}
                                target="explr-tooltip-EW"
                                toggle={() => this.toggleTooltip()}
                            >
                                After the store's scheduled closing hours, the AI checks for lights being left ON
                            </Tooltip>
                        </Col>
                        <Modal
                        ...
                        >
                            ...
                            <div className="modal-body">
                                ...
                                <ComparisonGraph
                                    dataType='Count'
                                    route='electricity_wastage/hourwise'
...
export default ElectricityWastage;