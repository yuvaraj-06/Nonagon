...
class CustomerTimeInsightsCard extends Component {
  constructor(props) {
    super(props);
    this.state = {
      exampleModal: false,
          ...
          this._ismounted &&
            this.setState({
              avg_display_counter_timespent: (
                res.data.avg_display_counter_timespent / 60
              ).toFixed(2),
              avg_billing_counter_timespent: (
                res.data.avg_billing_counter_timespent / 60
              ).toFixed(2),
              avg_waiting_around_timespent: (
                res.data.avg_waiting_around_timespent / 60
              ).toFixed(2),
        ...
        <CardBody>
                ...
                <Row>
                  <Col xs="4" sm="4">
                    <span className="h5 font-weight-bold mb-0 text-nowrap">
                      ...
                      <br />
                      {this.state.avg_display_counter_timespent}
                    </span>
                  </Col>
                  ...
                  <Col xs="4" sm="4">
                    <span className="h5 font-weight-bold mb-0 text-nowrap">
                      ...
                      <br />
                      {this.state.avg_billing_counter_timespent}
                    </span>
                  </Col>
                  ...
                  {Object.keys(this.props.companyServices)[0] !== "GVTPL-KMTTSIN001" ?
                    <Col xs="4" sm="4">
                      <span className="h5 font-weight-bold mb-0 text-nowrap">
                        ...
                        <br />
                        {this.state.avg_waiting_around_timespent}
                      </span>
                    </Col>
                    : null}
                </Row>
          ...
          <div className="mb-0 text-sm">
            <div className="mt-2">
              ...
              <Link to='/admin/customer-time-insights'>
                <Button
          ...
          <Col>
            ...
            >
              The average time (in mins) spent by the customer at the display counter, at the biling counter and waiting around in the store. For reference image click learn more button.
            </Tooltip>
          </Col>
          <Modal
...
// export default CustomerTimeInsightsCard;
export default connect(mapStateToProps)(CustomerTimeInsightsCard);