...
class SuspicionCountCard extends Component {
    ...
    fetchData = (nextProps) => {
        this._ismounted && axios.get(
            nodeBaseURL +
            `anpr/aggregate/${nextProps.outlet}/${nextProps.time}?fromdate=${nextProps.startDate}&tilldate=${nextProps.endDate}`,
            {
                headers: {
            ...
            .then((res) => {
                this._ismounted && this.setState({
                    anpr_count: res.data.anpr_count,
