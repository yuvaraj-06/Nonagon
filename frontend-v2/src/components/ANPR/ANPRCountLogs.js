...
class ANPRLogs extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            logsData: [],
            ...
            logsName: 'Number Plate Detection',
            outlet: props.outlet,
            time: props.time,
            daterange: "Loading...",
    ...
    fetchData = (nextProps) => {
        this._ismounted && axios.get(
            nodeBaseURL +
            `anpr/logs/${nextProps.outlet}/${nextProps.time}`,
            {
                headers: {
            ...
            .then((res) => {
                var x = res.data
                    ...
                    // .map((r) => ({
                        ...
                        // number_plate: r.number_plate.toString().toUpperCase(),
